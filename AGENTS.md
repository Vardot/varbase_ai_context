...
Guidance for AI coding agents working on the Varbase AI Context recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_ai_context](https://git.drupalcode.org/project/varbase_ai_context/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_ai_context](https://www.drupal.org/project/issues/varbase_ai_context)
